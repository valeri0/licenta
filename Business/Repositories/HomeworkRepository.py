...
class HomeworkRepository:
    ...
    def get_incomplete_homeworks_for_user(self,user_id):
        return UserHomeworkDifficulty.query.filter(UserHomeworkDifficulty.user_id == user_id,UserHomeworkDifficulty.completed == 0,UserHomeworkDifficulty.expired == 0).order_by(UserHomeworkDifficulty.days_remaining.asc()).all()
